      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Fonctionnalité disponible dans la Phase 4
          </p>
          <div className="glass-effect rounded-xl p-8 max-w-2xl mx-auto">
            <h2 className="text-2xl font-bold text-white mb-4">Prochainement</h2>
            <p className="text-gray-300 leading-relaxed">
              Le système de tournois complet sera disponible bientôt, incluant :
            </p>
            <ul className="text-left text-gray-300 mt-4 space-y-2">
              <li>• Brackets simple et double élimination</li>
              <li>• Gestion des équipes</li>
              <li>• Report de scores</li>
              <li>• Validation par arbitres</li>
              <li>• Upload de preuves (screenshots/vidéos)</li>
